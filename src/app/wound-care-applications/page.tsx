...
import { ArrowRight, ExternalLink, Award, Globe, Shield, Zap, Microscope, Users, Building2, Heart, Bandage, Stethoscope } from "lucide-react"
      ...
      <Section className="py-16 bg-gray-50">
        <div className="max-w-container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Advanced Wound Care Applications</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Tiger Wound Care provides Cellular, Acellular, and Matrix-like Products (CAMPs) tailored for chronic and hard-to-treat wounds. Our innovative research and development drive technologies suitable for all care settings with clinically validated outcomes.
            </p>
          </div>
      ...
      <Section className="py-16 bg-white">
        <div className="max-w-container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Wound Care Applications</h2>
            <p className="text-lg text-muted-foreground">
              Comprehensive solutions for various wound types and care settings
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-6">
              <CardContent className="p-0">
                ...
                <h3 className="text-lg font-semibold mb-2">Chronic Wounds</h3>
                <p className="text-sm text-muted-foreground">
                  Advanced solutions for chronic wounds including diabetic ulcers, pressure sores, and venous leg ulcers.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6">
              <CardContent className="p-0">
                ...
                <h3 className="text-lg font-semibold mb-2">Surgical Wounds</h3>
                <p className="text-sm text-muted-foreground">
                  Specialized treatments for surgical wounds, incisions, and post-operative care with optimal healing outcomes.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6">
              <CardContent className="p-0">
                ...
                <h3 className="text-lg font-semibold mb-2">Trauma Wounds</h3>
                <p className="text-sm text-muted-foreground">
                  Emergency and trauma wound care solutions for acute injuries and complex wound management scenarios.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="group hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <Button asChild variant="outline" size="sm">
                  <Link href="https://tigerwoundcare.com/" target="_blank" rel="noopener noreferrer">
                    Visit Website
