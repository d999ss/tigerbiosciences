...
export default function TissueProcessing() {
  return (
    <UseCasePage
      badge="Professional Tissue Processing"
      title="Tissue Processing"
      description="Tiger BioSciences provides professional tissue processing services with the highest standards of quality, safety, and regulatory compliance. Our advanced processing capabilities ensure optimal tissue integrity and biological activity for clinical applications."
      primaryCta={{ href: "/contact", label: "Request Processing Services" }}
      secondaryCta={{ href: "/our-companies", label: "Learn About RegenTX" }}
    >
