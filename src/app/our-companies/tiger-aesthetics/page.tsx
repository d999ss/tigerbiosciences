...
export default function TigerAesthetics() {
  return (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                <span className="text-tiger-red">Tiger Aesthetics</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Shaping the Future of Aesthetics. Delivering cutting-edge solutions across reconstructive, cosmetic, and regenerative domains with advanced CAMP technologies and personalized approaches.
              </p>
      ...
      <Section className="py-16 bg-gray-50">
        <div className="max-w-container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">About Tiger Aesthetics</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Tiger Aesthetics delivers cutting-edge solutions across reconstructive, cosmetic, and regenerative domains. Each product is designed to meet personalized needs and maximize clinical results with advanced CAMP technologies and innovative approaches.
            </p>
          </div>
