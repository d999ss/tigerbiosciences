...
export default function TigerWoundCare() {
  return (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                <span className="text-tiger-red">Tiger Wound Care</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Advanced CAMP Solutions for Complex Wounds. Providing Cellular, Acellular, and Matrix-like Products (CAMPs) tailored for chronic and hard-to-treat wounds with clinically validated outcomes.
              </p>
      ...
      <Section className="py-16 bg-gray-50">
        <div className="max-w-container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">About Tiger Wound Care</h2>
        ...
        <div className="max-w-container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Explore other companies in the Tiger Wound Care division
            </p>
          </div>
